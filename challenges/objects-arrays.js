...
*/
const animalNames = [];
zooAnimals.forEach((animal) => animalNames.push(`"Name": ${animal.scientific_name}, "Scientific": ${animal.animal_name}`));
...
*/
const populationTotal = zooAnimals.reduce((accPop, animal) => {
  return accPop += animal.population;
}, 0);
